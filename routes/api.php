...
Route::group(['middleware' => ['json.response']], function () {
    ...
    Route::get('/article/{id}/comments', [ArticleCommentController::class, 'index'])->name('articlecomments.index');
    Route::get('/article/{id}/comment/{commentId}', [ArticleCommentController::class, 'show'])->name('articlecomments.show');
    Route::post('/article/{id}/comment', [ArticleCommentController::class, 'store'])->name('articlecomments.store');
    Route::put('/article/{id}/comment/{commentId}', [ArticleCommentController::class, 'update'])->name('articlecomments.update');
    Route::delete('/article/{id}/comment/{commentId}', [ArticleCommentController::class, 'delete'])->name('articlecomments.delete');

    Route::get('/product/{id}/comments', [ProductCommentController::class, 'index'])->name('productcomments.index');
    Route::get('/product/{id}/comment/{commentId}', [ProductCommentController::class, 'show'])->name('productcomments.show');
    Route::post('/product/{id}/comment', [ProductCommentController::class, 'store'])->name('productcomments.store');
    Route::put('/product/{id}/comment/{commentId}', [ProductCommentController::class, 'update'])->name('productcomments.update');
    Route::delete('/product/{id}/comment/{commentId}', [ProductCommentController::class, 'delete'])->name('productcomments.delete');
